...
public abstract class NfcDetectorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            intentProcessed = savedInstanceState.getBoolean("intentProcessed");
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putBoolean("intentProcessed", intentProcessed);
    ...
    public void processIntent() {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(intent.getAction())) {
            ...
            nonNfcIntentDetected(intent, intent.getAction());
        }
    }
    ...
    /**
     * Incoming non nfc intent detected
     */
    protected abstract void nonNfcIntentDetected(Intent intent, String action);
